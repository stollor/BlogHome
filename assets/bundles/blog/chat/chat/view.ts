...
// 	@property(ChatListView) pageView: Virtua;
...
// 		var list: IChatItem[] = [];
// 		let msg1 = ['<color=#0000ff>10:59</color>', '恭喜玩家<color=#00ff00>蔡徐坤</color>获得神器<color=#ff0000>红莲铠甲</color>', '您已通过第<color=#00ff00>10</color>关'][~~(3 * Math.random())];
// 		let msg2 = [
// 			'大佬们,第5关怎么过?',
// 			'有没有兑换码?',
// 			'工会招人拉!',
