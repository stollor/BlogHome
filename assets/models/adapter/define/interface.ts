...
export interface InterData {
	prefab: string;
	onShow: (comp: Holder) => void;
	onCreate?: (comp: Holder) => void;
	onHide?: (comp: Holder) => void;
	onShowAni?: (comp: Holder) => void;
	onHideAni?: (comp: Holder) => void;
	onClick?: (comp: Holder) => void;
	onCreat?: (comp: Holder) => void;
	element?: Partial<IElement>;
}

export interface IVirtualItem extends InterData {
	data: any;
}
