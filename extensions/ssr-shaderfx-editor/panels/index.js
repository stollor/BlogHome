...
require("../ssr-shaderfx-editor/src/settings.js");
require("../ssr-shaderfx-editor/main.js");
...
exports.style = Fs.readFileSync(Path.join(__dirname, '../ssr-shaderfx-editor/style-desktop.css'), "utf8");
...
exports.ready = async function () {
  function polyfill () {
        cc.game._initRenderer = function () {
            ...
            if (CC_JSB || CC_RUNTIME) {
              ...
              var element = document.getElementById("dock").shadowRoot.childNodes[7].childNodes[0].childNodes[1].childNodes[0].shadowRoot.getElementById("GameDiv");
  ...
  let self = this;
  loadScript(Path.join(__dirname, '../ssr-shaderfx-editor/cocos2d-js-min.js'), function() {
      polyfill();
      window.boot();
  });
};
...
// Editor.Panel.extend({
//     style: Fs.readFileSync(Path.join(__dirname, '../ssr-shaderfx-editor/style-desktop.css'), "utf8"),
//     template: `
//         <div id="GameDiv" style="width:1336px; height: 640px;">
//             <canvas id="GameCanvas"></canvas>
//         </div>
...
//         }
//         let self = this;
//         loadScript(("../ssr-shaderfx-editor/ssr-shaderfx-editor/cocos2d-js-min.js", "utf8"), function() {
//             self.polyfill();
//             window.boot();
//         });
//     },
