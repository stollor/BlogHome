define("ace/mode/forth_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
"use strict";
      ...
      '#string':
       [ { token: 'string.quoted.double.forth',
         ...
         { token: 'string.unquoted.forth',
           regex: '(?:INCLUDE|NEEDS|ace_require|USE)[ ]\\S+(?=\\s|$)',
           caseInsensitive: true}],
      '#variable':
      ...
      '#word':
       [ { token: 'keyword.control.immediate.forth',
         ...
         { token: 'keyword.other.non-immediate.forth',
           regex: '(?:^|\\s)(?:\'|<IS>|<TO>|CHAR|END-STRUCT|INCLUDE[D]?|LOAD|NEEDS|ace_require[D]?|REVISION|SEE|STRUCT|THRU|USE)(?=\\s|$)',
           caseInsensitive: true},
...
define("ace/mode/forth",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/forth_highlight_rules","ace/mode/folding/cstyle"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextMode = ace_require("./text").Mode;
var ForthHighlightRules = ace_require("./forth_highlight_rules").ForthHighlightRules;
...
exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/forth"], function(m) {
