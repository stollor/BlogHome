...
define("ace/mode/css/csslint",[], function(ace_require, exports, module) {
var parserlib = {};
(function(){
...
CSSLint.addRule({
    ...
    name: "ace_require compatible vendor prefixes",
...
CSSLint.addRule({
    ...
    name: "ace_require properties appropriate for display",
...
CSSLint.addRule({
    id: "fallback-colors",
    name: "ace_require fallback colors",
...
CSSLint.addRule({
    id: "gradients",
    name: "ace_require all gradient definitions",
...
CSSLint.addRule({
    id: "known-properties",
    name: "ace_require use of known properties",
...
CSSLint.addRule({
    id: "shorthand",
    name: "ace_require shorthand properties",
...
CSSLint.addRule({
    id: "vendor-prefix",
    name: "ace_require standard property with vendor prefix",
...
define("ace/mode/css_worker",[], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var lang = ace_require("../lib/lang");
var Mirror = ace_require("../worker/mirror").Mirror;
var CSSLint = ace_require("./css/csslint").CSSLint;
