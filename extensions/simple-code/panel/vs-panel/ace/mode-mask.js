...
define("ace/mode/mask_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules","ace/mode/javascript_highlight_rules","ace/mode/css_highlight_rules","ace/mode/markdown_highlight_rules","ace/mode/html_highlight_rules"], function(ace_require, exports, module) {
"use strict";
...
var oop = ace_require("../lib/oop");
var lang = ace_require("../lib/lang");
var TextRules   = ace_require("./text_highlight_rules").TextHighlightRules;
var JSRules     = ace_require("./javascript_highlight_rules").JavaScriptHighlightRules;
var CssRules    = ace_require("./css_highlight_rules").CssHighlightRules;
var MDRules     = ace_require("./markdown_highlight_rules").MarkdownHighlightRules;
var HTMLRules   = ace_require("./html_highlight_rules").HtmlHighlightRules;
...
define("ace/mode/mask",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/mask_highlight_rules","ace/mode/matching_brace_outdent","ace/mode/behaviour/css","ace/mode/folding/cstyle"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextMode = ace_require("./text").Mode;
var MaskHighlightRules = ace_require("./mask_highlight_rules").MaskHighlightRules;
...
exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/mask"], function(m) {
