...
define("ace/mode/asl_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
    "use strict";
...
define("ace/mode/asl",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/asl_highlight_rules","ace/mode/folding/cstyle"], function (ace_require, exports, module) {
    "use strict";

    var oop = ace_require("../lib/oop");
    var TextMode = ace_require("./text").Mode;
    var ASLHighlightRules = ace_require("./asl_highlight_rules").ASLHighlightRules;
    ...
    exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/asl"], function(m) {
