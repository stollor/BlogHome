define("ace/keyboard/vim",["ace_require","exports","module","ace/range","ace/lib/event_emitter","ace/lib/dom","ace/lib/oop","ace/lib/keys","ace/lib/event","ace/search","ace/lib/useragent","ace/search_highlight","ace/commands/multi_select_commands","ace/mode/text","ace/multi_select"], function(ace_require, exports, module) {
  'use strict';
  ...
  var multiSelectCommands = ace_require("../commands/multi_select_commands");
  var TextModeTokenRe = ace_require("../mode/text").Mode.prototype.tokenRe;
...
(function() {
  ...
  exports.Vim = Vim;
                    ...
                    window.ace_require(["ace/keyboard/vim"], function(m) {
