define("ace/ext/linking",["ace_require","exports","module","ace/editor","ace/config"], function(ace_require, exports, module) {
...
function onClick(e) {
    ...
    if (button == 0 && ctrl) {
        ...
        editor._emit("linkClick", {position: docPos, token: token});
                    ...
                    window.ace_require(["ace/ext/linking"], function(m) {
