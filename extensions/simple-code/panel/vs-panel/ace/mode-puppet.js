define("ace/mode/puppet_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function (ace_require, exports, module) {
"use strict";
...
var PuppetHighlightRules = function () {
    this.$rules = {
        "start": [
            ...
            {
                token: "keyword.control.puppet",
                regex: "\\b(import|default|inherits|include|ace_require|contain|node|application|consumes|environment|site|function|produces)\\b"
            },
            {
...
define("ace/mode/puppet",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/puppet_highlight_rules","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/mode/matching_brace_outdent"], function (ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextMode = ace_require("./text").Mode;
var PuppetHighlightRules = ace_require("./puppet_highlight_rules").PuppetHighlightRules;
...
exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/puppet"], function(m) {
