...
define("ace/mode/php_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function(ace_require, exports, module) {
"use strict";
...
regexiterator|register_shutdown_function|register_tick_function|rename|rename_function|ace_require|require_once|reset|resetValue|\
...
public|static|switch|throw|trait|try|use|var|while|xor|yield'.split('|')
    ...
    var languageConstructs = lang.arrayToMap(
        ('__halt_compiler|die|echo|empty|exit|eval|include|include_once|isset|list|ace_require|require_once|return|print|unset').split('|')
    );
...
define("ace/mode/php_laravel_blade_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/php_highlight_rules"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var PhpHighlightRules = ace_require("./php_highlight_rules").PhpHighlightRules;
...
define("ace/mode/php_completions",["ace_require","exports","module"], function(ace_require, exports, module) {
"use strict";
...
define("ace/mode/php",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/php_highlight_rules","ace/mode/php_highlight_rules","ace/mode/matching_brace_outdent","ace/range","ace/worker/worker_client","ace/mode/php_completions","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/unicode","ace/mode/html","ace/mode/javascript","ace/mode/css"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextMode = ace_require("./text").Mode;
var PhpHighlightRules = ace_require("./php_highlight_rules").PhpHighlightRules;
var PhpLangHighlightRules = ace_require("./php_highlight_rules").PhpLangHighlightRules;
var MatchingBraceOutdent = ace_require("./matching_brace_outdent").MatchingBraceOutdent;
var Range = ace_require("../range").Range;
var WorkerClient = ace_require("../worker/worker_client").WorkerClient;
var PhpCompletions = ace_require("./php_completions").PhpCompletions;
var CstyleBehaviour = ace_require("./behaviour/cstyle").CstyleBehaviour;
var CStyleFoldMode = ace_require("./folding/cstyle").FoldMode;
...
define("ace/mode/php_laravel_blade",["ace_require","exports","module","ace/lib/oop","ace/mode/php_laravel_blade_highlight_rules","ace/mode/php","ace/mode/javascript","ace/mode/css","ace/mode/html"], function(ace_require, exports, module) {
    "use strict";

    var oop = ace_require("../lib/oop");
    var PHPLaravelBladeHighlightRules = ace_require("./php_laravel_blade_highlight_rules").PHPLaravelBladeHighlightRules;
    var PHPMode = ace_require("./php").Mode;
    var JavaScriptMode = ace_require("./javascript").Mode;
    var CssMode = ace_require("./css").Mode;
    var HtmlMode = ace_require("./html").Mode;
    ...
    exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/php_laravel_blade"], function(m) {
