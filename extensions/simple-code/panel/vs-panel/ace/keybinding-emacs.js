define("ace/occur",["ace_require","exports","module","ace/lib/oop","ace/range","ace/search","ace/edit_session","ace/search_highlight","ace/lib/dom"], function(ace_require, exports, module) {
"use strict";
...
define("ace/commands/occur_commands",["ace_require","exports","module","ace/config","ace/occur","ace/keyboard/hash_handler","ace/lib/oop"], function(ace_require, exports, module) {

var config = ace_require("../config"),
    Occur = ace_require("../occur").Occur;
...
define("ace/commands/incremental_search_commands",["ace_require","exports","module","ace/config","ace/lib/oop","ace/keyboard/hash_handler","ace/commands/occur_commands"], function(ace_require, exports, module) {

var config = ace_require("../config");
var oop = ace_require("../lib/oop");
var HashHandler = ace_require("../keyboard/hash_handler").HashHandler;
var occurStartCommand = ace_require("./occur_commands").occurStartCommand;
...
define("ace/incremental_search",["ace_require","exports","module","ace/lib/oop","ace/range","ace/search","ace/search_highlight","ace/commands/incremental_search_commands","ace/lib/dom","ace/commands/command_manager","ace/editor","ace/config"], function(ace_require, exports, module) {
"use strict";
...
var Search = ace_require("./search").Search;
var SearchHighlight = ace_require("./search_highlight").SearchHighlight;
var iSearchCommandModule = ace_require("./commands/incremental_search_commands");
...
var commands = ace_require("./commands/command_manager");
(function() {
...
define("ace/keyboard/emacs",["ace_require","exports","module","ace/lib/dom","ace/incremental_search","ace/commands/incremental_search_commands","ace/keyboard/hash_handler","ace/lib/keys"], function(ace_require, exports, module) {
"use strict";

var dom = ace_require("../lib/dom");
ace_require("../incremental_search");
var iSearchCommandModule = ace_require("../commands/incremental_search_commands");


var HashHandler = ace_require("./hash_handler").HashHandler;
...
var keys = ace_require("../lib/keys").KEY_MODS;
...
exports.killRing = {
    ...
    rotate: function() {
        ...
        return this.get();
                    ...
                    window.ace_require(["ace/keyboard/emacs"], function(m) {
