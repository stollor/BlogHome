define("ace/mode/qml_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
    "use strict";
...
define("ace/mode/qml",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/qml_highlight_rules","ace/mode/folding/cstyle"], function(ace_require, exports, module) {
    "use strict";

    var oop = ace_require("../lib/oop");
    var TextMode = ace_require("./text").Mode;
    var QmlHighlightRules = ace_require("./qml_highlight_rules").QmlHighlightRules;
    ...
    exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/qml"], function(m) {
