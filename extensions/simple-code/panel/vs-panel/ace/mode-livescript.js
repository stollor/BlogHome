...
define("ace/mode/livescript",["ace_require","exports","module","ace/tokenizer","ace/mode/matching_brace_outdent","ace/mode/behaviour/cstyle","ace/mode/text"], function(ace_require, exports, module){
  ...
  exports.Mode = LiveScriptMode = (function(superclass){
    ...
    function LiveScriptMode(){
      var that;
      this.$tokenizer = new (ace_require('../tokenizer')).Tokenizer(LiveScriptMode.Rules);
      if (that = ace_require('../mode/matching_brace_outdent')) {
        this.$outdent = new that.MatchingBraceOutdent;
      }
      this.$id = "ace/mode/livescript";
      this.$behaviour = new (ace_require("./behaviour/cstyle").CstyleBehaviour)();
    }
...
function import$(obj, src){
  ...
  return obj;
                    ...
                    window.ace_require(["ace/mode/livescript"], function(m) {
