define("ace/mode/csp_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
    "use strict";
    ...
    var CspHighlightRules = function() {
        var keywordMapper = this.createKeywordMapper({
            "constant.language": "child-src|connect-src|default-src|font-src|frame-src|img-src|manifest-src|media-src|object-src"
                  ...
                  + "|report-to|upgrade-insecure-requests|block-all-mixed-content|ace_require-sri-for|reflected-xss|referrer|policy-uri",
...
define("ace/mode/csp",["ace_require","exports","module","ace/mode/text","ace/mode/csp_highlight_rules","ace/lib/oop"], function(ace_require, exports, module) {
    "use strict";

    var TextMode = ace_require("./text").Mode;
    var CspHighlightRules = ace_require("./csp_highlight_rules").CspHighlightRules;
    var oop = ace_require("../lib/oop");
    ...
    exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/csp"], function(m) {
