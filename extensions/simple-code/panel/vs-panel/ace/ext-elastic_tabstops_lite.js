define("ace/ext/elastic_tabstops_lite",["ace_require","exports","module","ace/editor","ace/config"], function(ace_require, exports, module) {
"use strict";
        ...
        set: function(val) {
            if (val) {
                ...
                this.removeListener("change", this.elasticTabstops.onChange);
                    ...
                    window.ace_require(["ace/ext/elastic_tabstops_lite"], function(m) {
