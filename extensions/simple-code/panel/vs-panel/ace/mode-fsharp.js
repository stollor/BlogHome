define("ace/mode/fsharp_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function (ace_require, exports, module) {
"use strict";
...
define("ace/mode/fsharp",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/fsharp_highlight_rules","ace/mode/folding/cstyle"], function (ace_require, exports, module) {
    "use strict";

    var oop = ace_require("../lib/oop");
    var TextMode = ace_require("./text").Mode;
    var FSharpHighlightRules = ace_require("./fsharp_highlight_rules").FSharpHighlightRules;
    ...
    exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/fsharp"], function(m) {
