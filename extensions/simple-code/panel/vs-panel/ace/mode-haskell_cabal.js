define("ace/mode/haskell_cabal_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
"use strict";
...
define("ace/mode/folding/haskell_cabal",["ace_require","exports","module","ace/lib/oop","ace/mode/folding/fold_mode","ace/range"], function(ace_require, exports, module) {
"use strict";
...
define("ace/mode/haskell_cabal",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/haskell_cabal_highlight_rules","ace/mode/folding/haskell_cabal"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextMode = ace_require("./text").Mode;
var CabalHighlightRules = ace_require("./haskell_cabal_highlight_rules").CabalHighlightRules;
var FoldMode = ace_require("./folding/haskell_cabal").FoldMode;
...
exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/haskell_cabal"], function(m) {
