define("ace/keyboard/sublime",["ace_require","exports","module","ace/keyboard/hash_handler"], function(ace_require, exports, module) {
"use strict";
...

{
    ...
    exports.handler.bindKey(binding.bindKey, command || binding.name);
                    ...
                    window.ace_require(["ace/keyboard/sublime"], function(m) {
