define("ace/mode/gcode_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
    "use strict";
...
define("ace/mode/gcode",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/gcode_highlight_rules","ace/range"], function(ace_require, exports, module) {
    "use strict";

    var oop = ace_require("../lib/oop");
    var TextMode = ace_require("./text").Mode;
    var GcodeHighlightRules = ace_require("./gcode_highlight_rules").GcodeHighlightRules;
    ...
    exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/gcode"], function(m) {
