...
define("ace/ext/emmet",["ace_require","exports","module","ace/keyboard/hash_handler","ace/editor","ace/snippets","ace/range","ace/config","resources","resources","tabStops","resources","utils","actions"], function(ace_require, exports, module) {
"use strict";
var HashHandler = ace_require("../keyboard/hash_handler").HashHandler;
var Editor = ace_require("../editor").Editor;
...
AceEmmetEditor.prototype = {
    setupContext: function(editor) {
        ...
        if (!emmet)
            emmet = window.emmet;
        var resources = emmet.resources || emmet.ace_require("resources");
    ...
    $updateTabstops: function(value) {
        ...
        var zeroBase = 0;
        var lastZero = null;
        var ts = emmet.tabStops || emmet.ace_require('tabStops');
        var resources = emmet.resources || emmet.ace_require("resources");
        ...
        if (settings.variables['insert_final_tabstop'] && !/\$\{0\}$/.test(value)) {
            ...
            var common = emmet.utils ? emmet.utils.common : emmet.ace_require('utils');
...
exports.runEmmetCommand = function runEmmetCommand(editor) {
    ...
    try {
        ...
        var actions = emmet.actions || emmet.ace_require("actions");
...
exports.setCore = function(e) {
    if (typeof e == "string")
       ...
       emmet = e;
                    ...
                    window.ace_require(["ace/ext/emmet"], function(m) {
