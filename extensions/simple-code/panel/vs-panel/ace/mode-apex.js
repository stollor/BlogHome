...
define("ace/mode/apex_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules","ace/mode/doc_comment_highlight_rules"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextHighlightRules = ace_require("../mode/text_highlight_rules").TextHighlightRules;
var DocCommentHighlightRules = ace_require("../mode/doc_comment_highlight_rules").DocCommentHighlightRules;
...
define("ace/mode/apex",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/apex_highlight_rules","ace/mode/folding/cstyle","ace/mode/behaviour/cstyle"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextMode = ace_require("../mode/text").Mode;
var ApexHighlightRules = ace_require("./apex_highlight_rules").ApexHighlightRules;
var FoldMode = ace_require("../mode/folding/cstyle").FoldMode;
var CstyleBehaviour = ace_require("../mode/behaviour/cstyle").CstyleBehaviour;
...
exports.Mode = ApexMode;
                    ...
                    window.ace_require(["ace/mode/apex"], function(m) {
