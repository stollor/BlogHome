define("ace/mode/aql_highlight_rules",["ace_require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
  "use strict";
...
define("ace/mode/aql",["ace_require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/aql_highlight_rules"], function(ace_require, exports, module) {
  "use strict";

  var oop = ace_require("../lib/oop");
  var TextMode = ace_require("./text").Mode;
  var AqlHighlightRules = ace_require("./aql_highlight_rules").AqlHighlightRules;
  ...
  exports.Mode = Mode;
                    ...
                    window.ace_require(["ace/mode/aql"], function(m) {
